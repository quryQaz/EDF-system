...
const Drivers = (observer(class extends React.Component {
    ...
    loadData = () => {
        basicRequestPost(`${config.BACKEND_URL}/api/drivers`, {ip: this.props.ip}).then((response) => {
